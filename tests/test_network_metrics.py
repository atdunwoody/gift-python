...
class NetworkMetricsTests(unittest.TestCase):
    ...
    def test_summary_reports_mean_max_and_full_discharge_range(self):
        ...
        dimensionless = curve["d.suit"] * curve["v.suit"] * curve["s.suit"]
        ...
        self.assertAlmostEqual(
            result.iloc[0]["WUA_dimensionless_mean"], dimensionless.mean()
        )
        self.assertAlmostEqual(
            result.iloc[0]["WUA_dimensionless_max"], dimensionless.max()
        )
    ...
    def test_invalid_normalization_width_only_nulls_normalized_metrics(self):
        ...
        self.assertTrue(result["WUA_dimensionless_mean"].notna().all())
        self.assertTrue(result["WUA_dimensionless_max"].notna().all())
    ...
    def test_missing_hydraulic_inputs_keep_features_and_null_all_model_metrics(self):
        ...
        for column in (
            "WUA_mean", "WUA_max", "WUA_dimensionless_mean",
            "WUA_dimensionless_max", "WUA_Q_min_m3s", "WUA_Q_max_m3s",
